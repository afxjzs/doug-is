			...
			<div className="container mx-auto px-4 py-4">
				<div className="flex items-center justify-center">
					...
					<div className="flex items-center space-x-1">
						...
						{/* Mobile menu button */}
						<button
							className="md:hidden ml-4 text-[rgba(var(--color-foreground),0.9)]"
				...
				{/* Mobile navigation */}
				{isMenuOpen && (
					<nav className="md:hidden mt-4 p-4 bg-[rgba(var(--color-background),0.95)] backdrop-blur-md rounded-lg border border-[rgba(var(--color-foreground),0.1)] animated-border">
...
function MobileNavLink({
	...
	return (
		<Link
			href={href}
			onClick={onClick}
			className={`text-lg py-2 px-4 rounded-md transition-all duration-300 ${
				isActive
